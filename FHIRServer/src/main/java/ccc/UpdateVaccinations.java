...
/**
 * Servlet implementation class UpdateVaccinations
 */
public class UpdateVaccinations extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateVaccinations() {
        super();
	...
	void DoMySQL(String[] p) throws Exception{
		...
		String[] key = {"vid","pid","VaccineName","VaccineCode"};
