...
/**
 * Servlet implementation class DeleteEncounter
 */
public class DeleteEncounter extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String s = request.getParameter("de0");
		PrintWriter writer = response.getWriter();
		try {
			DoMySQL(s);
			writer.println("<html>");
			writer.println("<header>");
			writer.println("<meta http-equiv=\"refresh\"content=\"0;url=http://172.18.221.213:8080/FHIRServer/Encounter.jsp\">");
			//writer.println("<meta http-equiv=\"refresh\"content=\"0;url=http://localhost:8080/FHIRServer/Encounter.jsp\">");
			writer.println("</header>");
	...
	void DoMySQL(String p) throws Exception{
		...
		String sql = "delete from encounter where eid ="+p+";";
